...
var gauges = (function () {
    var strings = LANG.EN,         //Set to your default language. Store all the strings in one object
        config = {
            ...
            counter           : 12,                     //download data counter (secs, default 60)
            ...
            realTimeURL_WC     : 'data/realtimegaugesWC.txt',   //*** WeatherCat Users: Change to your location of the JSON script generator ***
